...
const AllAgents = () => {
    ...
    const ActiveChat = [
        ...
        { id: '5', name: 'Rabika', role: 'Broker', image: require('../../Assets/Images/hotel.png') },
        { id: '6', name: 'Rabika', role: 'Broker', image: require('../../Assets/Images/hotel.png') },
        { id: '7', name: 'Rabika', role: 'Broker', image: require('../../Assets/Images/hotel.png') },
        { id: '8', name: 'Rabika', role: 'Broker', image: require('../../Assets/Images/hotel.png') },
    ];
    ...
    const renderOnline = ({ item, navigation }: { item: any, navigation: any }) => (
        ...
        <Swipeable renderRightActions={() => renderRightActions(item)}>
            <TouchableOpacity
                onPress={() => navigation.navigate("ChatInbox" as never)}
                    ...
                    ListHeaderComponent={
                        <View style={styles.mainContainer}>
                            <View style={styles.flex}>
                                ...
                                <Text style={styles.Contact}>{t("Agents")}</Text>
                            </View>
